...
{
    public partial class newinitailDb : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                name: "BlogBlogCategoryAllocationInfo",
                columns: table => new
                {
                    Id = table.Column<long>(type: "bigint", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_BlogBlogCategoryAllocationInfo", x => x.Id);
                });

            migrationBuilder.CreateTable(
                name: "BlogCategoryInfo",
                columns: table => new
                {
                    Id = table.Column<long>(type: "bigint", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_BlogCategoryInfo", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MyCycle = table.Column<DateTime>(type: "datetime2", nullable: false),
                    Ovulation_date = table.Column<DateTime>(type: "datetime2", nullable: false),
                    Last_Mens_Start = table.Column<DateTime>(type: "datetime2", nullable: false),
                    Last_Mens_End = table.Column<DateTime>(type: "datetime2", nullable: false),
                    Next_Mens_Start = table.Column<DateTime>(type: "datetime2", nullable: false),
                    Next_Mens_End = table.Column<DateTime>(type: "datetime2", nullable: false),
                    Ovulation_Window_Start = table.Column<DateTime>(type: "datetime2", nullable: false),
                    Ovulation_Window_End = table.Column<DateTime>(type: "datetime2", nullable: false),
                    CreationTime = table.Column<DateTime>(type: "datetime2", nullable: false),
                    CreatorUserId = table.Column<long>(type: "bigint", nullable: true),
                    LastModificationTime = table.Column<DateTime>(type: "datetime2", nullable: true),
                    LastModifierUserId = table.Column<long>(type: "bigint", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ProductParametersInfo", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                name: "SubCategoryImageAllocationInfo",
                columns: table => new
                {
                    Id = table.Column<long>(type: "bigint", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_SubCategoryImageAllocationInfo", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_SubCategoryInfo", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                name: "SubscriptionOrderPayementAllocationInfo",
                columns: table => new
                {
                    Id = table.Column<long>(type: "bigint", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_SubscriptionOrderPayementAllocationInfo", x => x.Id);
                });

            migrationBuilder.CreateTable(
                name: "SubscriptionTypeInfo",
                columns: table => new
                {
                    Id = table.Column<long>(type: "bigint", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_SubscriptionTypeInfo", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Name = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    DateAndTime = table.Column<DateTime>(type: "datetime2", nullable: false),
                    StartDatePeriod = table.Column<DateTime>(type: "datetime2", nullable: false),
                    EndDatePeriod = table.Column<DateTime>(type: "datetime2", nullable: false),
                    UniqueKey = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    CreationTime = table.Column<DateTime>(type: "datetime2", nullable: false),
                    CreatorUserId = table.Column<long>(type: "bigint", nullable: true),
                    LastModificationTime = table.Column<DateTime>(type: "datetime2", nullable: true),
            ...
            migrationBuilder.CreateTable(
                name: "UserProductAllocationInfo",
                columns: table => new
                {
                    Id = table.Column<long>(type: "bigint", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_UserProductAllocationInfo", x => x.Id);
                });

            migrationBuilder.CreateTable(
                name: "UsersDetailsInfo",
                columns: table => new
                {
                    Id = table.Column<long>(type: "bigint", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_UsersDetailsInfo", x => x.Id);
                });
