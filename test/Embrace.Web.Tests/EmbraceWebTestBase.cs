...
{
    public abstract class EmbraceWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static EmbraceWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(EmbraceWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<EmbraceDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<EmbraceDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<EmbraceDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<EmbraceDbContext, Task<T>> func)
        {
            T result;
